  ...
  >
    <div class="container mx-auto px-4 max-w-7xl">
      <div class="mb-16 text-center">
        ...
        <div class="h-1 w-24 bg-blue-500 mx-auto rounded-full shadow-[0_0_10px_rgba(59,130,246,0.8)] mb-6" />
        <p class="text-slate-400 max-w-2xl mx-auto text-lg">
          Ask my AI assistant anything about my experience, skills, and projects.
        </p>
      </div>
      ...
      <div class="glass-card max-w-2xl mx-auto rounded-2xl overflow-hidden border border-slate-700/50 shadow-2xl flex flex-col">
        ...
        >
          <div class="flex flex-col space-y-4">
            ...
            <div
              v-if="isLoading"
              class="self-start bg-[#0f1629]/50 border border-slate-700/50 text-slate-200 rounded-2xl rounded-tl-sm p-4 max-w-[85%] chat-message"
            >
        ...
        <div class="p-4 bg-[#0f1629] border-t border-slate-800">
          ...
          <div
            ...
            class="text-xs text-center text-slate-500 mt-2"
          >
