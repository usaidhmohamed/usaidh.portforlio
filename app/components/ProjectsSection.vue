...
const { animateOnScroll, staggerChildren } = useScrollAnimation()
  ...
  >
    <div class="container mx-auto px-4 max-w-7xl">
      <div class="mb-8 md:mb-16 text-center">
        ...
        <div class="h-1 w-24 bg-blue-500 mx-auto rounded-full shadow-[0_0_10px_rgba(59,130,246,0.8)]" />
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div
          ...
          :key="index"
          class="glass-card glow-border p-8 rounded-2xl flex flex-col h-full animate-on-scroll"
        >
          <div class="mb-6 flex-grow">
            <span class="text-sm font-medium text-slate-400 mb-2 block">Project 0{{ index + 1 }}</span>
            <h3 class="text-xl lg:text-2xl font-semibold text-white mb-6">
              {{ project.title }}
            </h3>
          ...
          <div class="flex flex-wrap gap-2 mt-auto pt-6 border-t border-slate-700/50">
            <UBadge
